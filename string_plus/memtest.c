...
int main() {
  ...
  len2 = my_sprintf(str2, "|%u|", (unsigned int)li);
  ...
  len2 = my_sprintf(str2, "|%o|", (unsigned int)li);
  ...
  len2 = my_sprintf(str2, "|%x|", (unsigned int)li);
